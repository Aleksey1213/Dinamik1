...
int Task1() {
    /*
        Задание 1:
        Дан массив из n целых чисел, n <= 20. Количество элементов и элементы массива пользователь вводит с клавиатуры.
        Написать программу которая заменяет все отрицательные элементы нулями.
    */
...
int Task3() {
    /*
        Задание 3:
        Дан массив из n целых чисел, n <= 50.
        Сосчитать среднее арифметическое чётных значений массива. Если размерность <= 10, вывести исходные данные и ответ.
    */
